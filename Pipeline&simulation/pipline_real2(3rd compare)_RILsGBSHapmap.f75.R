	...
	for(i in 1201:1350){
		...
		if(missing_flag=="0.01"){match=5;mismatch=-5;d=1;e=3}
		if(missing_flag=="0.05"){match=4;mismatch=-4;d=1;e=3}
		if(missing_flag=="0.1"){match=5;mismatch=-5;d=1;e=3}
		if(missing_flag=="0.5"){match=5;mismatch=-5;d=1;e=3}
		if(missing_flag=="0.8"){match=5;mismatch=-1;d=2;e=3}
...
############treatment
	...
	print(count)
	setwd(root)
	write.table(result, file = "result_for_score_test_chr09.txt", sep = ",", row.names = FALSE,quote=F)
